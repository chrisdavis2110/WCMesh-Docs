...
A single byte can only have 256 possible values, much like a single English letter can only have 26 possible values. Ideally, every repeater has a unique key prefix. This is impossible with more than 256 repeaters.
